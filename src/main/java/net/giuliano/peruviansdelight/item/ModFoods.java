...
public class ModFoods {
    public static final FoodProperties CAUSA = new FoodProperties.Builder().nutrition(6).saturationMod(0.2f).meat().build();
    public static final FoodProperties INCA_KOLA = new FoodProperties.Builder().fast().alwaysEat().nutrition(2).saturationMod(0.1f)
