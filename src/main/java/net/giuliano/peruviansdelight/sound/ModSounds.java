package net.giuliano.peruviansdelight.sound;
...
public class ModSounds {
    public static final DeferredRegister<SoundEvent> SOUND_EVENTS =
            DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, PeruviansDelight.MOD_ID);

    public static final RegistryObject<SoundEvent> INCA_KOLA_AAAAH = registerSoundEvents("inca_kola_aaaah");
    ...
    private static RegistryObject<SoundEvent> registerSoundEvents(String name) {
        return SOUND_EVENTS.register(name, () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(PeruviansDelight.MOD_ID, name)));
    }
